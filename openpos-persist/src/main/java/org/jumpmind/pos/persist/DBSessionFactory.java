...
public class DBSessionFactory {
    ...
    protected void initSchema() {
        ...
        this.queryTemplates.replaceModelClassNamesWithTableNames(databaseSchema, modelClasses, (shadowTablesConfig != null) && shadowTablesConfig.validateTablesInQueries());
    }
