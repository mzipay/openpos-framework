export class Product {
    ...
    static getProducts() {
        return [
            new Product("810198450", "Ashley Storey Living Room Sectional, 2-Piece Set", "Bring modern appeal with a comfortable design into your home with the Signature Design by Ashley® Storey sectional collection.  Rich in relaxation and design, this set allows for everyone to have a cozy spot. ",
