...
public class ContextModule implements Module {
    ...
    private static Logger log = Logger.getLogger(ContextModule.class);
    ...
    Server h2Server() {
        String configDbUrl = env.getProperty(DB_POOL_URL, "jdbc:h2:mem:context");
    ...
    BasicDataSource dataSource() {
        if (dataSource == null) {
            ...
            properties.put(DB_POOL_URL, env.getProperty(DB_POOL_URL, "jdbc:h2:mem:context"));
            ...
            log.info(String.format(
                    "About to initialize the 'context' module datasource using the following driver:"
    ...
    @Bean(name="contextSessionFactory")
    public DBSessionFactory getSessionFactory() {
        ...
        sessionContext.put("CREATE_BY", "openpos-context");
        sessionContext.put("LAST_UPDATE_BY", "openpos-context");        
