...
@Plugin(name = "OpenposRollingFile", category = Core.CATEGORY_NAME, elementType = Appender.ELEMENT_TYPE, printObject = true)
public class OpenposLog4j2Appender extends AbstractOutputStreamAppender<RollingFileManager> {
    ...
    private OpenposLog4j2Appender(final String name, final Layout<? extends Serializable> layout, final Filter filter,
    ...
    public static class Builder<B extends Builder<B>> extends AbstractOutputStreamAppender.Builder<B>
            implements org.apache.logging.log4j.core.util.Builder<OpenposLog4j2Appender> {
        ...
        @Override
        public OpenposLog4j2Appender build() {
            ...
            final RollingFileManager manager = OpenposRollingFileManager.getFileManager(fileName, filePattern, append,
            ...
            return new OpenposLog4j2Appender(getName(), layout, getFilter(), manager, fileName, filePattern,
    ...
    class OpenposRollingFileManager extends RollingFileManager {

        protected OpenposRollingFileManager(LoggerContext loggerContext, String fileName, String pattern, OutputStream os,
