...
public class ModelMarkDownGeneratorConstants {
	...
	public static final String MODELS_HEADING = "# Database Schema By Module";
	public static final String MODULE_HEADING = "## ";
	public static final String COLUMNS_HEADING = "###### Columns";
