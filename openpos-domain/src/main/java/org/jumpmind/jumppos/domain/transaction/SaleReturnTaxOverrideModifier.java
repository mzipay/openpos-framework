 ...
 * RetailTransaction that provides supplementary data regarding tax overrides.
 * (Where the amount of tax collected is reduced rather than exempted).
 * 
 * @author elong
 * 
 */
@Entity
public class SaleReturnTaxOverrideModifier extends BaseEntity {
